...
<template>
  <div class="container mx-auto grid flex-1 grid-cols-1 gap-8 lg:grid-cols-2 lg:items-center lg:justify-center">
    ...
    <div class="flex flex-1 flex-col gap-2 overflow-auto lg:items-center lg:justify-center">
      ...
      <div class="flex max-h-[calc(100vh-6rem)] w-full flex-1 flex-col gap-2 rounded bg-white py-4 shadow-main lg:max-h-[60vh]">
